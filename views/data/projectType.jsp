	...
	<div class="tree">
		<div class="validDate">
			<label for="lastUpdated">Last Update</label> <input type="text"
				readonly="readonly" value="${lastUpdated}" class="text"
				id="lastUpdated" />
		</div>
	</div>
	...
	var projectType = {
		...
		initGrid : function() {
			var options = {
				...
				colNames : [ 'ID', 'Project Type', 'Order Number', 'Flag',
						'Remarks' ],
				colModel : [ {
					name : 'projectTypeID',
					index : 'projectTypeID',
			...
			grid.jqGrid(options).jqGrid('filterToolbar', {
		...
		getMasterData : function() {
			var url = "<c:url value='/masterData' />/0/" + projectType.DATA
					+ "/get";
			var obj = null;
